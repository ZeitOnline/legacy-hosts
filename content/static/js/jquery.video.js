...
(function($) {
  $.fn.video = function (defaults) {
    ...
    $(".playmediacp").live("click", function(e){
	...
	var initParamPresets = function(){
	    	...
	    	if(options.debug.html5 === "true" || options.debug.forcetablet == 'on'){
    ...
    var options = $.extend({
      ...
      autoplay			: false,
      bannerchannel		: 'none',
      headerNav			: '<div class="vid_nav clear"><div class="left vid_headline">Weitere Videos</div><div class="pagenav"><a href="#" class="rwd_inactive" title="Vorherige Seite">Vorherige Seite</a><span class="numbers"></span><a href="#" class="fwd_inactive" title="Nächste Seite">Nächste Seite</a></div></div><div class="vid_rotator">',
      ...
      footerNav			: '</div><div class="clear"><a class="left" href="http://video.zeit.de/">[Alle Filme im Überblick: zur Video-Startseite]</a></div>',
   	...
   	function videoClass(divId){
		...
		this.createUrlText = function (text, url){
   		...
   		this.collectData = function (data,mediaType){
   			...
   			//if no playlist get video or audio data
   				...
   				//grab caption text
   	   			...
   	   			//grab preview image
   	   			if(data.response.docs[0]["graphical-preview-url-large"] != undefined){
   	   				this.stillImage   	= data.response.docs[0]["graphical-preview-url-large"];
   	   			}
   		...
   		this.getVideoSettings = function(){
            ...
            $(".showVideoHd",this.divId).live("click", function(event){
        	...
        	$('.stillImage',this.divId).live("click", function(event){
        		event.preventDefault();
   		...
   		this.getThumbs = function(playlistId){
   			...
   			//if list of videos exists grab their data	
	   	        ...
	   	        var imageField = 'graphical-preview-url-large';
   			...
   			$.each(this.videoList, function(index,value){
   				...
   				if(value.url !== undefined && value.image !== undefined && value.title !== undefined){
		            ...
		            thumbHtml 	+=	'<li class="narrow ' + margin + addClass + '">'
					      		...
					      		+	'<img class="left" height="99" width="175" width src="' + value.image + '" /></a><div class="title">'
					      		+	'<a class="'+useThumbClass+'" data-sourceplsid="' + that.mediaId + '" data-mediaid="vid' + index + '" href="' + href + '">'
   		...
   		this.appendPlayer = function (usePlayer,mediaType){
            ...
            if(usePlayer == 'html5'){
    	        ...
    	        //enable webtrekk at play	
                $("#"+this.mediaType+this.mediaId).live("play", function(event){
                	ZEIT.clickWebtrekk('redaktion.video...video../'+event.target.id+'/No_Title_avai_HTML5/START');
                });
            	...
            	setPlayer = '<div class="stillImage"><span class="'+addClass+'"> </span><img src="'+this.stillImage+'" width="'+options.playertypes[this.playerType].width+'" height="'+options.playertypes[this.playerType].height+'"></div>';
            }
